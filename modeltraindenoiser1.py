...
from model import make_model,subsequent_mask,make_std_mask,make_decoder,make_denoiser1
...
#感觉修改此处即可
        ...
        output= output+model2.forward(output)
    ...
    if epoch%10==0: #== 0:
        ...
        torch.save(model2.module.state_dict() if data_parallel else model2.state_dict(),
                   os.path.join(save_model_path, 'denoiser1_epoch{}.pth'.format(epoch)))
